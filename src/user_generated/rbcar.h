...
{
    geometry_msgs::PoseStamped subscriber0_old_msg_, subscriber1_old_msg_;
...
public:
    ...
    void setStateSubscriberRosTopicName(std::string rostopicname)
    {
        ...
        *ros_state_subscribers_[0] = ros_node_.subscribe<geometry_msgs::PoseStamped>(rostopicname, 1, &Rbcar::subStateCallback, this);
    };
