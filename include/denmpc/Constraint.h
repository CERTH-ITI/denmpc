...
public:
	...
	inline void setParameter(double *_vector)
	{
		for (int i = 0; i < dim_pc_; i++)
		{
			pc_[i] = _vector[i];
	...
	inline void setParameter(std::vector<double> _vector)
	{
		for (int i = 0; i < dim_pc_; i++)
		{
			pc_[i] = _vector[i];
	...
	inline void setInitialParameter(double *_vector)
	{
		for (int i = 0; i < dim_pc_; i++)
		{
			pc_[i] = _vector[i];
	...
	inline void setInitialParameter(std::vector<double> _vector)
	{
		for (int i = 0; i < dim_pc_; i++)
		{
			pc_[i] = _vector[i];
