...
public:
	...
	inline void getState(double *_vector)
	{
	...
	inline void getControl(double *_vector)
	{
	...
	inline void getOutput(double *_vector)
	{
	...
	inline void getDisturbance(double *_vector)
	{
		for (int i = 0; i < dim_d_; i++)
		{
			_vector[i] = d_[i];
		}
	};
	inline void getDesiredState(double *_vector)
	{
		for (int i = 0; i < dim_xdes_; i++)
		{
			_vector[i] = xdes_[i];
		}
	};
	inline void getDesiredControl(double *_vector)
	{
		for (int i = 0; i < dim_udes_; i++)
		{
			_vector[i] = udes_[i];
		}
	};
	inline void getDesiredOutput(double *_vector)
	{
		for (int i = 0; i < dim_ydes_; i++)
		{
			_vector[i] = ydes_[i];
		}
	};
	inline void getParameter(double *_vector)
	{
	...
	inline void getState(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_x_; i++)
		{
			_vector[i] = x_[i];
	...
	inline void getControl(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_u_; i++)
		{
			_vector[i] = u_[i];
	...
	inline void getOutput(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_y_; i++)
		{
			_vector[i] = y_[i];
	...
	inline void getDesiredState(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_xdes_; i++)
		{
			_vector[i] = xdes_[i];
	...
	inline void getDesiredControl(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_udes_; i++)
		{
			_vector[i] = udes_[i];
	...
	inline void getDesiredOutput(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_ydes_; i++)
		{
			_vector[i] = ydes_[i];
	...
	inline void getParameter(std::vector<double> &_vector)
	{
		for (int i = 0; i < dim_p_; i++)
		{
			_vector[i] = p_[i];
